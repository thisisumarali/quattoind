...
export const metadata = {
  ...
  description:
    "Get in touch with our Pakistan head office in Karachi or our US liaison office in Austin, Texas. Find our business hours, email and phone contact details.",
};
  ...
  const offices = [
    {
      ...
      phones: ["+92-301-2554453", "+92-330-8222274", "+92 (21) 35850003"],
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {businessHours.map((hour, idx) => (
                    ...
                    >
                      ...
                      <span
                        className={`text-base font-extrabold ${hour.highlight ? "text-rose-500" : "text-slate-900"}`}
                      >
                        {hour.time}
                      </span>
                    </div>
