  ...
  const slides = [
    {
      ...
      description:
        "Direct import from manufacturers in USA. Authenticity guaranteed with factory test results and unique serial numbers.",
      image: "/hero-1.jpg",
    },
    {
      title: "Filmtec Membranes (USA) in Stock for Immediate Delivery",
      description:
        "Leading-brand brackish water and seawater membranes. Fully stocked in Karachi warehouse to serve your industrial needs.",
      image: "/hero-2.jpg",
    },
    {
      title: "Toray Membranes (USA) Available For All RO Plants",
      description:
        "High rejection, energy-efficient elements for brackish and seawater application with knowledgeable support in Pakistan.",
      image: "/hero-3.jpg",
    },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm font-semibold text-slate-500 leading-relaxed">
                Quattro Industries is a premier distributor of high-quality
                Reverse Osmosis (RO) components and water treatment solutions.
                With strong manufacturer relationships in the USA, we import
                direct to our کراچی (Karachi) warehouse to ensure the most
                cost-effective and authentic products reach our customers.
              </p>
            ...
            <div className="bg-slate-50 border border-slate-100 rounded-2xl p-8 space-y-6">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">
                At Quattro Industries, we align ourselves with standard-setting
                quality, prompt service, and unyielding support for clean water
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  {
                    title: "100% Genuine",
                    desc: "Certified RO membranes direct from US plants.",
                  },
                  {
                    title: "AWC Antiscalants",
                    desc: "Award-winning membrane chemical solutions.",
                  },
                  {
                    title: "Immediate Delivery",
                    desc: "Fully stocked Karachi logistics warehouse.",
                  },
                  {
                    title: "Unsurpassed Support",
                    desc: "Experienced local technical engineers.",
                  },
                ].map((item, idx) => (
                  <div
                    key={idx}
                    className="space-y-1.5 p-4 bg-white rounded-xl border border-slate-200/50 shadow-sm shadow-slate-100/10"
                  >
      ...
      <section className="bg-sky-950 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          <p className="text-sm font-bold uppercase tracking-widest text-sky-400">
            Complete Pakistan Distribution Footprint
          </p>
          <p className="text-base sm:text-lg text-slate-200 max-w-4xl mx-auto leading-relaxed">
            We provide RO filter media, system antiscalants, and membranes
            (brackish & seawater) from our Karachi head office to plants and
            municipal systems throughout Karachi, Lahore, Islamabad, and
            nationwide.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-sm text-slate-500 leading-relaxed">
              We carry only the top-performing, internationally recognized brand
              elements to keep your desalination and water treatment plants
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {categories.map((cat, i) => (
              ...
              >
                <div className="h-52 relative bg-slate-50 border-b border-slate-100 overflow-hidden flex items-center justify-center p-4">
                  <img
                    src={cat.image}
                    alt={cat.title}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm text-slate-500 leading-relaxed">
                Our support team is always ready to guide you. If you need
                membrane sizing help, antiscalant dose projection calculations,
                or filter media quantity estimates, feel free to contact us.
              </p>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-slate-900">
                      <a
                        href="mailto:info@quattroind.com"
